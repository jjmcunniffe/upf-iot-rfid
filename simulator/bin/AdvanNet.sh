...
DEPLOY_OPTS="-DLOG_LEVEL=info -Dcom.keonn.core.SimulatorMode=true -Dcom.keonn.system.defs=server -DKEONNBASE=$AGENT_HOME -DKEONNDEPLOY=$DEPLOY_DIR -Dlogback.configurationFile=$LOGBACK_PATH -DAGENT_ID=$AGENT_ID -DWORK_ENV=$WORK_ENV -DKEONN_COMP=$KEONN_COMP"
